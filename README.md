...
**cd; sudo yum install git -y > /dev/null 2>&1; git clone https://github.com/nagaraj602/install_jenkins_RHEL_Ubuntu.git > /dev/null; cd install_jenkins_RHEL_Ubuntu; bash jenkins.sh**
